...
;var saveAs=saveAs||(typeof navigator!=="undefined"&&navigator.msSaveOrOpenBlob&&navigator.msSaveOrOpenBlob.bind(navigator))||(function(C){if(typeof navigator!=="undefined"&&/MSIE [1-9]\./.test(navigator.userAgent)){return}var s=C.document,y=function(){return C.URL||C.webkitURL||C},F=C.URL||C.webkitURL||C,w=s.createElementNS("http://www.w3.org/1999/xhtml","a"),D=!C.externalHost&&"download" in w,A=function(a){var b=s.createEvent("MouseEvents");b.initMouseEvent("click",true,false,C,0,0,0,0,0,false,false,false,false,0,null);a.dispatchEvent(b)},v=C.webkitRequestFileSystem,u=C.requestFileSystem||v||C.mozRequestFileSystem,x=function(a){(C.setImmediate||C.setTimeout)(function(){throw a},0)},H="application/octet-stream",z=0,I=[],B=function(){var a=I.length;while(a--){var b=I[a];if(typeof b==="string"){F.revokeObjectURL(b)}else{b.remove()}}I.length=0},t=function(e,f,b){f=[].concat(f);var c=f.length;while(c--){var a=e["on"+f[c]];if(typeof a==="function"){try{a.call(e,b||e)}catch(d){x(d)}}}},E=function(l,i){var h=this,b=l.type,k=false,f,g,n=function(){var o=y().createObjectURL(l);I.push(o);return o},c=function(){t(h,"writestart progress write writeend".split(" "))},m=function(){if(k||!f){f=n(l)}if(g){g.location.href=f}else{if(navigator.userAgent.match(/7\.[\d\s\.]+Safari/)&&typeof window.FileReader!=="undefined"&&l.size<=1024*1024*150){var o=new window.FileReader();o.readAsDataURL(l);o.onloadend=function(){var p=s.createElement("iframe");p.src=o.result;p.style.display="none";s.body.appendChild(p);c();return};h.readyState=h.DONE;h.savedAs=h.SAVEDASUNKNOWN;return}else{window.open(f,"_blank");h.readyState=h.DONE;h.savedAs=h.SAVEDASBLOB;c();return}}},d=function(o){return function(){if(h.readyState!==h.DONE){return o.apply(this,arguments)}}},e={create:true,exclusive:false},a;h.readyState=h.INIT;if(!i){i="download"}if(D){f=n(l);s=C.document;w=s.createElementNS("http://www.w3.org/1999/xhtml","a");w.href=f;w.download=i;var j=s.createEvent("MouseEvents");j.initMouseEvent("click",true,false,C,0,0,0,0,0,false,false,false,false,0,null);w.dispatchEvent(j);h.readyState=h.DONE;h.savedAs=h.SAVEDASBLOB;c();return}if(C.chrome&&b&&b!==H){a=l.slice||l.webkitSlice;l=a.call(l,0,l.size,H);k=true}if(v&&i!=="download"){i+=".download"}if(b===H||v){g=C}if(!u){m();return}z+=l.size;u(C.TEMPORARY,z,d(function(o){o.root.getDirectory("saved",e,d(function(q){var p=function(){q.getFile(i,e,d(function(r){r.createWriter(d(function(L){L.onwriteend=function(K){g.location.href=r.toURL();I.push(r);h.readyState=h.DONE;h.savedAs=h.SAVEDASBLOB;t(h,"writeend",K)};L.onerror=function(){var K=L.error;if(K.code!==K.ABORT_ERR){m()}};"writestart progress write abort".split(" ").forEach(function(K){L["on"+K]=h["on"+K]});L.write(l);h.abort=function(){L.abort();h.readyState=h.DONE;h.savedAs=h.FAILED};h.readyState=h.WRITING}),m)}),m)};q.getFile(i,{create:false},d(function(r){r.remove();p()}),d(function(r){if(r.code===r.NOT_FOUND_ERR){p()}else{m()}}))}),m)}),m)},G=E.prototype,J=function(b,a){return new E(b,a)};G.abort=function(){var a=this;a.readyState=a.DONE;a.savedAs=a.FAILED;t(a,"abort")};G.readyState=G.INIT=0;G.WRITING=1;G.DONE=2;G.FAILED=-1;G.SAVEDASBLOB=1;G.SAVEDASURI=2;G.SAVEDASUNKNOWN=3;G.error=G.onwritestart=G.onprogress=G.onwrite=G.onabort=G.onerror=G.onwriteend=null;C.addEventListener("unload",B,false);J.unload=function(){B();C.removeEventListener("unload",B,false)};return J}(typeof self!=="undefined"&&self||typeof window!=="undefined"&&window||this.content));var swfobject;var __Flash_getFileData_callback;var Flash={callback:function(){},createButton:function(d,c){if(typeof c==="function"){this.callback=c}__Flash_getFileData_callback=this.callback;if(swfobject==undefined){var b=document.createElement("script");b.setAttribute("type","text/javascript");b.setAttribute("src",__ExcelPlus_flashPath+"/swfobject.js");document.getElementsByTagName("head")[0].appendChild(b);return this._waitForObjectToBeLoaded(d,c)}else{var a=120;swfobject.embedSWF(__ExcelPlus_flashPath+"/FileToDataURI.swf",d,a+"px","22px","10",__ExcelPlus_flashPath+"/expressInstall.swf",{},{},{})}},getFileData:function(a){__Flash_getFileData_callback(a)},_waitForObjectToBeLoaded:function(b,a){if(swfobject==undefined){setTimeout(function(){Flash._waitForObjectToBeLoaded(b,a)},50)}else{this.createButton(b,a)}}};